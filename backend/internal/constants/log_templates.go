...
var LogTemplates = map[string]string{
	...
	"peripheral_create_ok":     "peripheral create success, deviceNo=%s, deviceType=%s",
	"peripheral_status_change": "peripheral status change, peripheralID=%d, from=%s, to=%s, operator=%s",
	"rental_create_ok":         "peripheral rental create success, rentalID=%d, userID=%d, deviceNo=%s, deposit=%f, operator=%d",
	"rental_return_ok":         "peripheral rental return success, rentalID=%d, refund=%f, handler=%s",
	"rental_damage_ok":         "peripheral rental damage settle success, rentalID=%d, compensation=%f, debt=%f, handler=%s",
}
